...
CREATE TABLE "kixikilas" (
    ...
    CONSTRAINT "kixikilas_adminId_fkey" FOREIGN KEY ("adminId") REFERENCES "usuarios" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "UsuarioKixikila" (
    ...
    CONSTRAINT "UsuarioKixikila_id_kixikila_fkey" FOREIGN KEY ("id_kixikila") REFERENCES "kixikilas" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE "contas_bancarias" (
    ...
    CONSTRAINT "contas_bancarias_usuarioId_fkey" FOREIGN KEY ("usuarioId") REFERENCES "usuarios" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "carteiras" (
    ...
    "usuarioId" TEXT NOT NULL,
    CONSTRAINT "carteiras_usuarioId_fkey" FOREIGN KEY ("usuarioId") REFERENCES "usuarios" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "contas_bancarias_usuarioId_key" ON "contas_bancarias"("usuarioId");
